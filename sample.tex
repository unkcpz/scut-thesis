%% 使用 scutthesis 文档类生成华南理工大学学位论文的示例文档
%%
%% 作者：余橘颂，morty (dot) yeu (at) gmail (dot) com
%% 项目主页: https://github.com/unkcpz/scut-thesis/
%%
%% 修改自：
...
% 华工要求作者科研成果页，应放在结论之后、致谢之前。并以表格形式展示。
\begin{resume}
